(function () {
	...
	var obj =  function (env, pkg, server) {
		...
		this.getDNS = function () {
			...
			delete require.cache[env.config_path + '/dynamic_dnsPP.json'];	
			try { DS_d = require(env.config_path + '/dynamic_dnsPP.json'); } catch(e) {}
		...
		me.hubService = function (cfg, data) {
			...
			me.io.to(cfg.socketid).emit('hubService', {ip : ips, cfg : cfg, dns : me.getDNS() });		
		};
