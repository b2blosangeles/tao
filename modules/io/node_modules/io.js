	...
	var obj =  function (env, pkg, server, isSSL) {
		...
		me.hubLink = function(link_url, callback, err_callback) {
			...
			if (!me.ioPool[link_url] || !me.ioPool[link_url].link) {
				...
				if (me.ioPool[link_url].link.connected) {
					callback(me.ioPool[link_url].link,  true);
				}
			}
		}
