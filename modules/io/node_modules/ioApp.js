	...
	var obj =  function (IO, env, pkg, _pool, server, host, isSSL) {
		...
		this.hubRoom = function (incomeData) {
			...
			_f['self'] = function(cbk)  {
				...
				console.log(incomeData.from);
				me.roomDeliveryMessage(incomeData.room, 'MMBB');
				/*the 
		...
		me.roomDeliveryMessage = function (room, data) {
			let me = this;
			console.log('--roomDeliveryMessage-->');
			console.log(data);
			IO.io.to(room).emit('_incomeMessage_', data);	
		};		
