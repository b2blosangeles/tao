(function () {
	var obj =  function (env, pkg, server, isSSL) {
		...
		this.serverRule function(type, environment) {
			return new RegExp('^'+ type +'([0-9]+)\_' + environment + '\.([a-z0-9]+)\.([a-z]+)$', 'ig');
		}
		this.getCluster = function (host) {
			...
			for(o in me.domainList()) {
				if ((host.match(me.serverRule('comm', 'dev')) &&
						o.match(match(me.serverRule('comm', 'dev'))) 
