(function () {
	var obj =  function (IO, env, pkg, server, host, isSSL) {
		...
		this.hubToAServer = function (cfg, incomeData) {
			let me = this;
		...
		this.hubRoom = function (cfg, incomeData) {
			let me = this, clusters =  IO.getCluster(cfg.host);
				...
				switch(incomeData.cmd) {
					...
					case 'sendToClient':
						...
						if (!incomeData.toClient) {
							...
							me.hubToAServer(cfg, incomeData);
						}
						break;
					case 'leaveRoom':
							...
							socket.join(incomeData.room, function() {
								me.hubQuery(cfg, incomeData.room, incomeData.session_id, IO,
									...
									me.callbackMessage({
										...
										data: {data:data, success : true,
										      cfg: cfg,
										      handshake : socket.request.connection.remoteAddress
										}
									});
