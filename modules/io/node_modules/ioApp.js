				...
				switch(incomeData.cmd) {
					...
					case 'roomClients':
						...
						for (var o in _pool.sockets) {
							DT.push({id : _pool.sockets[o].link.id,
								host : _pool.sockets[o].host, 
								created : _pool.sockets[o].created,
								actived: _pool.sockets[o].actived,
								socket_from: _pool.sockets[o].socket_from,
								socket_to: o
							});
						}
						me.hubQuery(incomeData.room, incomeData.session_id, IO,
