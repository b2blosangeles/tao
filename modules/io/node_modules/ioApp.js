	...
	var obj =  function (IO, env, pkg, server, host, isSSL) {
		...
		me.hubLink = function(link_url, callback, err_callback) {
			...
			if (!me._PLL[link_url]) {
				...
				if (me._PLL[link_url].connected) {
						console.log('-no need link CCC>>>---' + link_url + '--ID==>' + me._PLL[link_url].id);
							console.log(me._PLL[link_url].connected);
							callback(me._PLL[link_url],  true);
				} else {
